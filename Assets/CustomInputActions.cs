...
public partial class @CustomInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""ARMobil"",
            ""id"": ""aff91107-23c5-4b92-a574-5d7882eefe9b"",
            ""actions"": [
                {
                    ""name"": ""Touch"",
                    ""type"": ""Value"",
                    ""id"": ""19c7c1fb-dde3-4f58-903a-35c78b48fe29"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
    ...
    ""controlSchemes"": []
        ...
        // ARMobil
        m_ARMobil = asset.FindActionMap("ARMobil", throwIfNotFound: true);
        m_ARMobil_Touch = m_ARMobil.FindAction("Touch", throwIfNotFound: true);
    }

    ~@CustomInputActions()
    {
        UnityEngine.Debug.Assert(!m_XRIHead.enabled, "This will cause a leak and performance issues, CustomInputActions.XRIHead.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRILeft.enabled, "This will cause a leak and performance issues, CustomInputActions.XRILeft.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRILeftInteraction.enabled, "This will cause a leak and performance issues, CustomInputActions.XRILeftInteraction.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRILeftLocomotion.enabled, "This will cause a leak and performance issues, CustomInputActions.XRILeftLocomotion.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRight.enabled, "This will cause a leak and performance issues, CustomInputActions.XRIRight.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightInteraction.enabled, "This will cause a leak and performance issues, CustomInputActions.XRIRightInteraction.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIRightLocomotion.enabled, "This will cause a leak and performance issues, CustomInputActions.XRIRightLocomotion.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_XRIUI.enabled, "This will cause a leak and performance issues, CustomInputActions.XRIUI.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_TouchscreenGestures.enabled, "This will cause a leak and performance issues, CustomInputActions.TouchscreenGestures.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_ARMobil.enabled, "This will cause a leak and performance issues, CustomInputActions.ARMobil.Disable() has not been called.");
    }
    ...
    public struct XRILeftActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRILeftActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct XRILeftInteractionActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRILeftInteractionActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct XRILeftLocomotionActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRILeftLocomotionActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct XRIRightActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRIRightActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct XRIRightInteractionActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRIRightInteractionActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct XRIRightLocomotionActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRIRightLocomotionActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct XRIUIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public XRIUIActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct TouchscreenGesturesActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public TouchscreenGesturesActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    // ARMobil
    private readonly InputActionMap m_ARMobil;
    private List<IARMobilActions> m_ARMobilActionsCallbackInterfaces = new List<IARMobilActions>();
    private readonly InputAction m_ARMobil_Touch;
    /// <summary>
    /// Provides access to input actions defined in input action map "ARMobil".
    /// </summary>
    public struct ARMobilActions
    {
        private @CustomInputActions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ARMobilActions(@CustomInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "ARMobil/Touch".
        /// </summary>
        public InputAction @Touch => m_Wrapper.m_ARMobil_Touch;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_ARMobil; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="ARMobilActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(ARMobilActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="ARMobilActions" />
        public void AddCallbacks(IARMobilActions instance)
        {
            if (instance == null || m_Wrapper.m_ARMobilActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ARMobilActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="ARMobilActions" />
        private void UnregisterCallbacks(IARMobilActions instance)
        {
            @Touch.started -= instance.OnTouch;
            @Touch.performed -= instance.OnTouch;
            @Touch.canceled -= instance.OnTouch;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ARMobilActions.UnregisterCallbacks(IARMobilActions)" />.
        /// </summary>
        /// <seealso cref="ARMobilActions.UnregisterCallbacks(IARMobilActions)" />
        public void RemoveCallbacks(IARMobilActions instance)
        {
            if (m_Wrapper.m_ARMobilActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="ARMobilActions.AddCallbacks(IARMobilActions)" />
        /// <seealso cref="ARMobilActions.RemoveCallbacks(IARMobilActions)" />
        /// <seealso cref="ARMobilActions.UnregisterCallbacks(IARMobilActions)" />
        public void SetCallbacks(IARMobilActions instance)
        {
            foreach (var item in m_Wrapper.m_ARMobilActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ARMobilActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="ARMobilActions" /> instance referencing this action map.
    /// </summary>
    public ARMobilActions @ARMobil => new ARMobilActions(this);
    /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "ARMobil" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="ARMobilActions.AddCallbacks(IARMobilActions)" />
    /// <seealso cref="ARMobilActions.RemoveCallbacks(IARMobilActions)" />
    public interface IARMobilActions
    {
        /// <summary>
